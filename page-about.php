    ...
    <div class="wrapper">
            ...
            <div class="about-box" id="annick">       
                <div class="wow animate__fadeInUp" data-wow-delay="0.1s">
                    <div class="grid-imgs">
                            <img class="grid-img-1" src="<?php the_field('petite_photo_haut');?>" alt="">                             
                            <img class="grid-img-2" src="<?php the_field('petite_photo_bas');?>" alt="">   
                            <img class="grid-img-3" src="<?php the_field('grande_photo_droite');?>" alt="">   
                    </div>
                </div>
